import { CasteData, CityData, CountryData, EthnicityData, relation, SocialProile, StateData } from "@/types";
...
export default function SocialProfileDetails() {
    const [step, setStep] = useState(1);
    const [formData, setFormData] = useState<SocialProile>({
        id: "",
        lookingFor: "",
    ...
    const handleChange = (key: keyof SocialProile, value: any) => {
                ...
                {step === 1 && (
                    <>
                        ...
                        <RNPickerSelect
                            ...
                            items={relation.map((r) => ({ label: r, value: r }))}
                            style={{
                                inputWeb: {
                                    fontSize: 16,
                                    paddingVertical: 10,
